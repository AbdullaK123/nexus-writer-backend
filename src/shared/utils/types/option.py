...
class Some(BaseModel, Generic[T], OptionMixin):
    model_config = ConfigDict(frozen=True, strict=True, extra="forbid")
    tag: OptionTag = Field(default=OptionTag.SOME, frozen=True)
    value: T


class Empty(BaseModel, OptionMixin):
    model_config = ConfigDict(frozen=True, strict=True, extra="forbid")
    tag: OptionTag = Field(default=OptionTag.EMPTY, frozen=True)

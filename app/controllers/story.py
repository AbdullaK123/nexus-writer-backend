...
from app.controllers.story_targets import router as targets_router
from app.controllers.story_plot import router as plot_router
from app.controllers.story_characters import router as characters_router
from app.controllers.story_structure import router as structure_router
from app.controllers.story_world import router as world_router
